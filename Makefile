...
# CXX Flags
#
COMMON_CXXFLAGS+=-Wall -Werror -MT $@ -MD -MP -MF $(@:%.o=%.d) -DVERSION=\"$(VERSION)\" -g -O2 -fsanitize=address -fsanitize=undefined
...
# LD Flags
#
COMMON_LDFLAGS+=-g -fsanitize=undefined -fsanitize=address
